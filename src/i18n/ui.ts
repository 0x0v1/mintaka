...
export const ui = {
	en: {
		...
		homepage: "Homepage",
		tagline:
			"The private sector, encroach on our ability to defend ourselves without their proprietary data hoarding technologies. We exist to challenge that.",
		...
		"hero.title.3": "Survellience",
		"hero.title.4": "Surveillance",
		"hero.subtitle":
		...
		"uiux.title": "Built for the Global South",
		"seo.title": "Decentralized",
		"advertising.title": "Ubiquitous", 
		"websites.content": "Our work fills critical gaps in spyware research, with the goal of enabling localized, decentralized, and public-interest threat labs to emerge around the world. Through open-source, community-driven tools and methodologies, we aim to decolonize and democratize threat research—pushing for independence from private-sector dominance.",
		"apps.content": "All of our tools are built in-house and open-source, ensuring full technological sovereignty, transparency, and trust. Nothing is outsourced. Nothing is proprietary. Our team builds everything for the people; by the people.",
		"uiux.content": "Our mission is to defend and support human rights defenders—particularly in East and Southeast Asia. We focus on tackling technological problems that affect the majority world. For example, we specialize in threat research on Android devices—which make up over 72% of the global mobile market and are the dominant platforms across Asia, Latin America, and Africa.",
		"seo.content": "All our technology is built for the purpose of self-hosting and self-agency. We intend to never create systems that require the need for centralization to us. We are not a threat lab; we focus on building open-source technology and do not offer paid services.",
		"advertising.content": "Our technologies are being built for the global majority, designed to serve all civic actors everywhere: NGOs, journalists, and community networks.",
